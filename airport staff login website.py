...
admin = {'arnav': 'arnav'}
manager = {'rakesh': 'rakesh'}
standard = {'standard': 'standard'}
scheduled = {'AGENTX44': ["10:10", 'Manali', "Delayed"], 'ADO2354': ['5:30', 'Cebu City', 'Delayed'],
             ...
             'LA3452': ['8:40', 'Dumaguete City', 'Scheduled'],'AB333452': ['9:32', 'Chicago', 'Scheduled'],
             'AB3452': ['10:50', 'Texas', 'Scheduled'],'FRET243': ['1:00', 'Israel', 'Delayed']}
cancelled = {'ASIA345556': ["3:00", "Mexico", "Cancelled"]}
...
def manager_main():  # supervisor control panel
    ...
    image = tk.PhotoImage(file="https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.airport-technology.com%2Ffeatures%2Ftalking-heads-trends-for-airports-2022%2F&psig=AOvVaw0DduzY_02Ss1tctWX3X_Z-&ust=1684514081377000&source=images&cd=vfe&ved=0CBEQjRxqFwoTCMj9842m__4CFQAAAAAdAAAAABAE")
